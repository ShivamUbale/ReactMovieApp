...
function MovieDetails() {
    ...
    return value ? (
        ...
        >
                ...
                <div className="content ml-[4%]">
                    <h1 className="text-6xl font-semibold">
                        ...
                        <small className="ml-3 text-xl font-bold text-zinc-300">
                            ({value.detail.release_date.split("-")[0]})
                        </small>
                    </h1>
                    ...
                    <div className="flex gap-x-4 mt-2">
                        ...
                        <h1 className="flex items-center gap-2 text-zinc-300">
                            <div className="w-1 h-1 rounded-full bg-zinc-300"></div>
                            {(value.detail.runtime / 60).toFixed()}h{" "}
                            {value.detail.runtime % 60}m
                        </h1>
                    </div>
            ...
            <h1 className="text-3xl font-semibold mb-3">Recommendations & Similar: </h1>
            <HorizontalCards data={value.recommendations.length > 0 ? value.recommendations : value.similar} />
